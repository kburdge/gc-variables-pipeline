...
from pipeline.catalog import load_labels, build_mapping  # noqa: E402
...
def main():
    ...
    master = build_mapping(load_labels(args.labels), dedup_arcsec=cfg["catalog"]["dedup_radius_arcsec"])
