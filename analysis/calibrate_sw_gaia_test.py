...
"""
===========================================================================
 TEST: Apply LW best-roundness recipe to SW detectors for Gaia alignment
===========================================================================

 Experimental script to see how the LW calibration recipe performs on SW.
 Same approach: best-roundness FWHM selection, |r1| < 0.1, IQR clip.
 FWHM grid adjusted for SW pixel scale (31 mas/px vs 63 mas/px for LW).

Usage:
    python calibrate_sw_gaia_test.py --target Terzan5 --det nrcb4
"""
import numpy as np
import os
import sys
...
# ── Detection parameters (SW: smaller FWHMs for 31 mas/px) ──
FWHM_GRID = [2, 3, 4, 5, 6, 8, 10, 12, 15]
...
def main():
    ...
    parser.add_argument('--det', default='nrcb4', help='SW detector (default: nrcb4)')
